...
// Append new users by replacing the end of mockUsers array
const newUsers = `,
  {
    id: "u8",
    username: "ansh_shriv",
...
// Append new asks by replacing the end of mockAsks array
const newAsks = `,
  {
    id: "a13",
    type: "build_log",
...
// Append new groups by replacing the end of mockGroups array
const newGroups = `,
  {
    id: "g6",
